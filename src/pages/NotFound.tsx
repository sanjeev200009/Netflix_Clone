  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-netflix-black text-white p-6">
      <div className="max-w-lg text-center">
        ...
        <Button className="bg-netflix-red hover:bg-netflix-red/90 text-white px-8 py-6 text-lg font-medium flex items-center gap-2 mx-auto shadow-lg hover:scale-105 transition-transform">
